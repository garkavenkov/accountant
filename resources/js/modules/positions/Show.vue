                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center">{{position.name}}</h3>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                              <li class="list-group-item">
                                ...
                                <a class="float-right">{{position.description}}</a>
                              </li>                              
                            </ul>
                    ...
                    <!-- <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Action area</h3>
                        </div>
                     
                        <div class="card-body">
                            <strong><i class="fas fa-building mr-1"></i> Подразделение</strong>
                            ...
                            <div class="tab-content">
                                        ...
                                        <tbody>
                                            <tr> -->
                                                ...
                                                <!-- <td>
                                                    ...
                                                    <br/>
                                                    <small>
                                                        Торговля алкогольно, слабоалкогольной продукцией.
                                                    </small>
                                                </td>
                                                <td>
                                            ...
                                            <tr> -->
                                                ...
                                                <!-- <td>
                                                    ...
                                                    <br/>
                                                    <small>
                                                        ТОрговля овощами, консервацией, рыбой
                                                    </small>
                                                </td>
                                                <td>
                                                    <ul class="list-inline">
                                ...
                                <div class="active tab-pane" id="employees">
                                    <table class="table table-striped projects">
                                        ...
                                        <tbody>
                                            <tr v-for="employee in position.employees" :key="employee.id">
                                                <!-- <td>
                                                    #
                                                </td> -->
                                                <td>
...
export default {
    ...
    methods: {
        fetchData() {               
            axios.get(`/api/positions/${this.id}`, 
                    {
                        'headers': {
