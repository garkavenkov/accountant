...
export default {
    ...
    methods: {        
        ...
        saveDoc() {
            let doc = {
                ...
                sum2                : parseFloat(this.document.markdownSum.replace(",", "."))
            }
    ...
    watch: {
        ...
        'document.markdownSum'(newValue, oldValue) {
