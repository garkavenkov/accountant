                        ...
                        <div class="card">
                            <div class="card-body">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-8">{{ document.writedownSum | formatNumber(2) }}</dd>
                                    <template v-if="correctWritedownSum">
                                        <dt class="col-sm-4">Расчетная сумма</dt>
                                        <dd class="col-sm-8">
                                            {{ totalWritedownSum | formatNumber(2) }}&nbsp;
                                            <button class="btn btn-info btn-sm" 
                                                    title="Скорректировать сумму списания" 
                                                    @click="updateDoc({writedownSum: totalWritedownSum})">
                                                Изменить
                                            </button>                                            
                                        </dd>
                                    </template>
                        ...
                        <table class="table table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right">{{totalWritedownSum }}</td>                                    
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
